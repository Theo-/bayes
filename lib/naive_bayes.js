...
Naivebayes.prototype.categorize = function(text) {
    ...
    Object
        ...
        .forEach(function(category) {
            ...
            categoriesLogProbailities[category] = logProbability;
        })

    categoriesLogProbailities['chosen'] = chosenCategory;

    return categoriesLogProbailities;
}
